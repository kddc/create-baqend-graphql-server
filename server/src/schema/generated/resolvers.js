let resolvers = {
  ...
  Query: {
    Test: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Test', args, {})
    },
    allTests: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceCollectionQuery('Test', args, {})
    },
    Comment: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Comment', args, {})
    },
    allComments: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceCollectionQuery('Comment', args, {})
    },
    Device: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Device', args, {})
    },
    allDevices: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceCollectionQuery('Device', args, {})
    },
    TestReference: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('TestReference', args, {})
    },
    ...
    Reference: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Reference', args, {})
    },
    ...
    Role: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Role', args, {})
    },
